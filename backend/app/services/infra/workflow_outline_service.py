...
async def get_outline_draft(db: AsyncSession, project_id: uuid.UUID) -> dict[str, Any] | None:
...
async def clear_outline_draft(db: AsyncSession, project_id: uuid.UUID) -> None:
