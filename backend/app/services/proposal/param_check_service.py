...
from app.services.infra.prompt_loader import load_param_check_prompt
...
async def check_chapter_params(content: str, score_points: list[dict[str, Any]]) -> list[str]:
