...
def natural_sort_key(no: str) -> tuple[tuple[int, object], ...]:
...
def is_nested_sections(sections: list[Any]) -> bool:
...
def numbered_sections(sections_tree: list[Any], chapter_no: str) -> list[tuple[str, str]]:
